<template>
  <section class="section has-text-white bg-dark-lighter">
    <div class="container">
      <div class="columns">
        <div class="column">
      ...
      carousels: [
        {
          ...
          href: 'https://github.com/Shivelle',
          snippet: '<img src="https://ghchart.rshah.org/FFA726/shivelle" alt="Github Chart" class="ghchart" />'
        },
        {
          title: 'CodePen',
          ...
          href: 'https://codepen.io/shivelle',
          snippet: ''
        },
        {
          title: 'Demos',
