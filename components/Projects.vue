          ...
          <article class="tile is-child p-4 bg-dark">
            <a href="https://centralstationcrm.de/" target="_blank">
              <div class="">
                ...
                <div class="has-text-grey-light">Redesign Backend</div>
                <div class="has-text-grey-light">Diverse Landingpages</div>
          ...
          <article class="tile is-child p-4 bg-dark">
            <a href="https://www.hn-feinmahltechnik.de/" target="_blank">
              <div class="">
                ...
                <div class="has-text-grey-light">Homepage-Design</div>
                <div class="has-text-grey-light">Visitenkarten-Design</div>
                <div class="has-text-grey-light">WordPress-Template-Entwicklung</div>
          ...
          <article class="tile is-child p-4 bg-dark">
            <a href="https://centralplanner.de/" target="_blank">
              <div class="">
                ...
                <div class="has-text-grey-light">Redesign Backend</div>
                <div class="has-text-grey-light">Auto-Mailing Features</div>
                <div class="has-text-grey-light">Custom Captcha Feature</div>
              </div>
            </a>
          </article>
